...
public class NPCDialogue : MonoBehaviour {
    ...
    private void Update() {
        if (UnityEngine.Input.GetKeyDown(KeyCode.Z) && !isInConversation) {
            metBefore = false;
            isAngry = false;
        }
        if (UnityEngine.Input.GetKeyDown(KeyCode.F) && !isInConversation) {
    ...
    public bool MetBefore(string node, int lineIndex) => metBefore;
    public bool Angry(string node, int lineIndex) => isAngry;
    public void Meet(string node, int lineIndex) => metBefore = true;
    public void MakeAngry(string node, int lineIndex) => isAngry = true;
    public void ClearAngry(string node, int lineIndex) => isAngry = false;
